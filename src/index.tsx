 ...
 *
 * /redux --> this folder is used to setup up redux manage a package which helps us manage global state.
 ...
 *
 * components/Home --> compenets that are rendered for ever page in the app {the NavBar and the Tabs folder}
 *
